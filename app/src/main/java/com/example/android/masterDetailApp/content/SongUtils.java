...
package com.example.android.masterDetailApp.content;
...
public class SongUtils {
    ...
    static {
        // Fill the array with masterDetailApp.
    ...
    private static Song createSongAtPosition(int position) {
        ...
        switch (position) {
            ...
            case 5:
                ...
                newDetail = "Leave My Kitten Alone\n\nOne of the lost Beatle masterDetailApp recorded during the “Beatles For Sale” sessions but never released. This song, written by Little Willie John, Titus Turner, and James McDougal, was a 1959 R&B hit for Little Willie John and covered by Johnny Preston before the Beatles tried it and shelved it. A reference to a “big fat bulldog” may have influenced John’s “Hey Bulldog” (Yellow Submarine album), which is a similar rocker.";
                break;
            default:
